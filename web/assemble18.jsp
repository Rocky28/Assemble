      ...
      <form action="selups" method="post">
          <table>
             <tr><td><select name="chooseups">
                        ...
                        <option value="IBALL NIRANTAR UPS 1080V">IBALL NIRANTAR UPS 1080V</option>
                        <option value="IBALL NIRANTAR UPS TOWER 603V">IBALL NIRANTAR UPS TOWER 603V</option>
                        <option value="IBALL NIRANTAR ONLINE 1044 CE(WITHOUT BATTERY)">IBALL NIRANTAR ONLINE 1044 CE(WITHOUT BATTERY)</option>
                        <option value="IBALL NIRANTAR ONLINE UPS 9099CE(10 KVA)">IBALL NIRANTAR ONLINE UPS 9099CE(10 KVA)</option>
                        <option value="IBALL NIRANTAR ONLINE UPS 6066CE(6 KVA)">IBALL NIRANTAR ONLINE UPS 6066CE(6 KVA)</option>
                        <option value="MICROTEK UPS 600VA HERITAGE PLUS">MICROTEK UPS 600VA HERITAGE PLUS</option>
                        <option value="MICROTEK 650VA E2- INVERTER/GERERATOR COMPATIBLE UPS">MICROTEK 650VA E2- INVERTER/GERERATOR COMPATIBLE UPS</option>
                        <option value="APC SUA750I UPS">APC SUA750I UPS</option>
                        <option value="INTEX BLACK ARMOUR 725 UPS(BLACK)">INTEX BLACK ARMOUR 725 UPS(BLACK)</option>
                        <option value="APC UPS BR800-IN UPS">APC UPS BR800-IN UPS</option>
                        <option value="APC SUA1000I UPS">APC SUA1000I UPS</option>
                        <option value="MICROTEK TUFF POWER">MICROTEK TUFF POWER</option>
                        <option value="INTEX PROTECTOR 800VA UPS(BLACK)">INTEX PROTECTOR 800VA UPS(BLACK)</option>
                        <option value="IBALL NIRANTAR UPS-621">IBALL NIRANTAR UPS-621</option>
                        <option value="APC SUA2200I UPS">APC SUA2200I UPS</option>
                        <option value="IBALL NIRANTAR 639">IBALL NIRANTAR 639</option>
                        <option value="IBALL NIRANTAR ONLINE 1044CB">IBALL NIRANTAR ONLINE 1044CB</option>
                        <option value="APC SUA1500I UPS">APC SUA1500I UPS</option>
                        <option value="INTEX 600VA UPS">INTEX 600VA UPS</option>
                     </select>
            </td></tr> 
             <tr><td><input type="submit" value="Preview" name="s1"></td><% HttpSession s=request.getSession(true); String from=(String)s.getAttribute("from"); if(from==null){%><td><a href="assemble19.jsp">Skip This One</a></td><% } %><td><input type="image" src="success.png" value="success" name="s2"></td></tr>
              
          </table>
      </form>
      
  </div>
  <div id="preview"><% String type=(String)s.getAttribute("type"); AssembleBean ob=new AssembleBean();ResultSet rs=ob.getTypeResults(type,"Ups"); while(rs.next()){%>
