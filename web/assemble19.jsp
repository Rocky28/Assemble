      ...
      <form action="seltvtuner" method="post">
          <table>
             <tr><td><select name="choosetvtuner">
                        ...
                        <option value="IBALL CLARO TV18 TV TUNER CARD">IBALL CLARO TV18 TV TUNER CARD</option>
                        <option value="BEETEL FUN TFT STYLE COMPUTER TV TUNER CARD">BEETEL FUN TFT STYLE COMPUTER TV TUNER CARD</option>
                        <option value="INTEX TV TUNER CRT">INTEX TV TUNER CRT</option>
                        <option value="LIVE TECH TV TUNER CARD(BLACK)">LIVE TECH TV TUNER CARD(BLACK)</option>
                        <option value="ENTER E-220U EXTERNAL TV TUNER FOR LCD(BLACK)">ENTER E-220U EXTERNAL TV TUNER FOR LCD(BLACK)</option>
                        <option value="ENTER E-210U EXTERNAL TV TUNER CARD FOR CRT">ENTER E-210U EXTERNAL TV TUNER CARD FOR CRT</option>
                        <option value="INTEX IT TV 150 FM USB STICK(BLACK)">INTEX IT TV 150 FM USB STICK(BLACK)</option>
                        <option value="INTEX IT 162 TV TUNER COMBO(BLACK)">INTEX IT 162 TV TUNER COMBO(BLACK)</option>
                        <option value="ZEBRONICS ZEB L2012 LCD EXTERNAL TV TUNER CARD">ZEBRONICS ZEB L2012 LCD EXTERNAL TV TUNER CARD</option>
                        <option value="AVERMEDIA AVERTV SUPER M733 PCI TV TUNER CARD">AVERMEDIA AVERTV SUPER M733 PCI TV TUNER CARD</option>
                        <option value="INTEX SKY PRO IT 193FM LCD LED TFT TV TUNER CARD">INTEX SKY PRO IT 193FM LCD LED TFT TV TUNER CARD</option>
                        <option value="HYTECH TV TUNER USB STICK HT 2535">HYTECH TV TUNER USB STICK HT 2535</option>
                        <option value="INTEX IT-163S TV TUNER CARD">INTEX IT-163S TV TUNER CARD</option>
                        <option value="INTEX SKY PRO IT 194 FM LCD TV TUNER CARD">INTEX SKY PRO IT 194 FM LCD TV TUNER CARD</option>
