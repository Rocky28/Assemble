      ...
      <form action="selsoundcard" method="post">
          <table>
             <tr><td><select name="choosesoundcard">
                        ...
                        <option value="ENTER E-4S PCI SOUND CARD 4 CHANNEL">ENTER E-4S PCI SOUND CARD 4 CHANNEL</option>     
                        <option value="LIVE TECH LT-PCI 1X SOUND CARD">LIVE TECH LT-PCI 1X SOUND CARD</option>     
                        <option value="QUANTUM HM623 USB SOUND CARD USB TO SPEAKER AND MIC(BLACK)">QUANTUM HM623 USB SOUND CARD USB TO SPEAKER AND MIC(BLACK)</option> 
                        <option value="LIVE TECH LT-PCI 4.1 SOUND CARD">LIVE TECH LT-PCI 4.1 SOUND CARD</option>     
                        <option value="LIVE TECH LT 5.1 CHANNEL USB TO SOUND CARD">LIVE TECH LT 5.1 CHANNEL USB TO SOUND CARD</option>     
                        <option value="LIVE TECH LT 7.1 CHANNEL USB TO SOUND CARD(BLACK)">LIVE TECH LT 7.1 CHANNEL USB TO SOUND CARD(BLACK)</option>     
                        <option value="ASUS XONAR ESSENCE STX SOUND CARD">ASUS XONAR ESSENCE STX SOUND CARD</option>     
             ...
             <tr><td><input type="submit" value="Preview" name="s1"></td><% HttpSession s=request.getSession(true); String from=(String)s.getAttribute("from"); if(from==null){%><td><a href="assemble16.jsp">Skip This One</a></td><% } %><td><input type="image" src="success.png" value="success" name="s2"></td></tr>
              
          </table>
      </form>
      
  </div>
  <div id="preview"><% String type=(String)s.getAttribute("type"); AssembleBean ob=new AssembleBean();ResultSet rs=ob.getTypeResults(type,"Soundcard"); while(rs.next()){%>
