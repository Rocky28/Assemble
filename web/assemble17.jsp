  ...
  <div id="assemble1">
      ...
      <form action="selwebcam" method="post">
          <table>
             ...
             <tr><td><input type="submit" value="Preview" name="s1"></td><% HttpSession s=request.getSession(true); String from=(String)s.getAttribute("from"); if(from==null){%><td><a href="assemble18.jsp">Skip This One</a></td><% } %><td><input type="image" src="success.png" value="success" name="s2"></td></tr>
              
          </table>
      </form>
      
  </div>
  <div id="preview"><% String type=(String)s.getAttribute("type"); AssembleBean ob=new AssembleBean();ResultSet rs=ob.getTypeResults(type,"Webcam"); while(rs.next()){%>
