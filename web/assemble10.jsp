...
<link rel="stylesheet" href="assemble1.css" type="text/css" media="screen" />
  ...
  <!-- End of Left Sidebar -->
  <div id="assemble1">
      <p class="p1">Choose your External Writer : </p>
      <form action="selexternalwriter" method="post">
          <table>
             <tr><td><select name="chooseexternalwriter">
                        <option value="default">Choose Your Item</option>
                        <option value="TRANSCEND SLIM PORTABLE CD/DVD WRITER(BLACK)">TRANSCEND SLIM PORTABLE CD/DVD WRITER(BLACK)</option>
                        <option value="HP 8X EXTERNAL SLIM MULTIFORMAT DVD/CD WRITER">HP 8X EXTERNAL SLIM MULTIFORMAT DVD/CD WRITER</option>
                        <option value="LG GP50NB40 EXTERNAL DVD WRITER(BLACK)">LG GP50NB40 EXTERNAL DVD WRITER(BLACK)</option>
                        <option value="LENOVO USB PORTABLE DVD BURNER">LENOVO USB PORTABLE DVD BURNER</option>
                        <option value="SAMSUNG TRAY LOAD SLIM DVD WRITER(BLACK)">SAMSUNG TRAY LOAD SLIM DVD WRITER(BLACK)</option>
                        <option value="TRANSCEND TS8XDVDS-K EXTERNAL DVD WRITER(BLACK)">TRANSCEND TS8XDVDS-K EXTERNAL DVD WRITER(BLACK)</option>
                        <option value="BUFFALO MEDIASTATION 8X PORTABLE CD/DVD WRITER">BUFFALO MEDIASTATION 8X PORTABLE CD/DVD WRITER</option>
                        <option value="IOMEGASUPER SLIM PORTABLE DVD WRITER">IOMEGASUPER SLIM PORTABLE DVD WRITER</option>
                        <option value="ASUS EXTREME 12X BLU RAY CD/DVD WRITER">ASUS EXTREME 12X BLU RAY CD/DVD WRITER</option>
                        <option value="BUFFALO MEDIASTATION 8X PORTABLE CD/DVD WRITER">BUFFALO MEDIASTATION 8X PORTABLE CD/DVD WRITER</option>
                        <option value="TRANSCEND SLIM PORTABLE CD/DVD WRITER(WHITE)">TRANSCEND SLIM PORTABLE CD/DVD WRITER(WHITE)</option>
                        <option value="LENOVO PORTABLE DVD WRITER(BLACK)">LENOVO PORTABLE DVD WRITER(BLACK)</option>
                        <option value="LITEON ETAU108 EXTERNAL DVD WRITER">LITEON ETAU108 EXTERNAL DVD WRITER</option>
                        <option value="ASUS SDRW-08D2S-U">ASUS SDRW-08D2S-U</option>                        
                     </select>
            </td></tr> 
             <tr><td><input type="submit" value="Preview" name="s1"></td><% HttpSession s=request.getSession(true); String from=(String)s.getAttribute("from"); if(from==null){%><td><a href="assemble11.jsp">Skip This One</a></td><% } %><td><input type="image" src="success.png" value="success" name="s2"></td></tr>
              
          </table>
      </form>
      
  </div>
  <div id="preview"><% ;String type=(String)s.getAttribute("type"); AssembleBean ob=new AssembleBean();ResultSet rs=ob.getTypeResults(type,"Externalwriter"); while(rs.next()){%>
