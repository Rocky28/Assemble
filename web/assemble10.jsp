  ...
  <div id="assemble1">
      ...
      <form action="selexternalwriter" method="post">
          <table>
             ...
             <tr><td><input name="s1" type="submit" value="Preview"></td><td><a href="assemble11.jsp">Skip this one</a></td><td><input type="image" src="success.png" name="s2" value="success"></td></tr>
              
          </table>
      </form>
      
  </div>
  <div id="preview"><% HttpSession s=request.getSession(true);String type=(String)s.getAttribute("type"); AssembleBean ob=new AssembleBean();ResultSet rs=ob.getTypeResults(type,"Externalwriter"); while(rs.next()){%>
