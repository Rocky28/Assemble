...
<link rel="stylesheet" href="assemble1.css" type="text/css" media="screen" />
  ...
  <!-- End of Left Sidebar -->
  <div id="assemble1">
      <p class="p1">Choose your Internal Writer : </p>
      <form method="post" action="selinternalwriter">
          <table>
             <tr><td><select name="chooseinternalwriter">
                        <option value="default">Choose Your Item</option>
                        <option value="HP DVD1260I OEM BUNDLE OF 3 DVD BURNER INTERNAL OPTICAL DRIVE">HP DVD1260I OEM BUNDLE OF 3 DVD BURNER INTERNAL OPTICAL DRIVE</option>
                        <option value="HP DVD 1260I-UH07D DVD BURNER INTERNAL OPTICAL DRIVE(BLACK)">HP DVD 1260I-UH07D DVD BURNER INTERNAL OPTICAL DRIVE(BLACK)</option>
                        <option value="SAMSUNG SH-224DB/IDDS DVD BURNER INTERNAL OPTICAL DRIVE">SAMSUNG SH-224DB/IDDS DVD BURNER INTERNAL OPTICAL DRIVE</option>
                        <option value="LG GH24NS95 DVD BURNER INTERNAL OPTICAL DRIVE">LG GH24NS95 DVD BURNER INTERNAL OPTICAL DRIVE</option>
                        <option value="ASUS DRW-24D3ST/BLK/G/AS DVD BURNER INTERNAL OPTICAL DRIVE">ASUS DRW-24D3ST/BLK/G/AS DVD BURNER INTERNAL OPTICAL DRIVE</option>
                        <option value="HP DVD1260I-UH06C DVD BURNER INTERNAL OPTICAL DRIVE(BLACK)">HP DVD1260I-UH06C DVD BURNER INTERNAL OPTICAL DRIVE(BLACK)</option>
                        <option value="LITEON IHAS122-06WU/IHAS122-05 WU DVD BURNER INTERNAL OPTICAL DRIVE">LITEON IHAS122-06WU/IHAS122-05 WU DVD BURNER INTERNAL OPTICAL DRIVE</option>
                        <option value="ASUS DRW-22B3S DVDBURNER INTERNAL OPTICAL DRIVE(BLACK)">ASUS DRW-22B3S DVDBURNER INTERNAL OPTICAL DRIVE(BLACK)</option>
                        <option value="HP DVD1260I OEM BUNDLE OF 5 DVD BURNER INTERNAL OPTICAL DRIVE">HP DVD1260I OEM BUNDLE OF 5 DVD BURNER INTERNAL OPTICAL DRIVE</option>
                        
                     </select>
            </td></tr> 
             <tr><td><input type="submit" value="Preview" name="s1"></td><% HttpSession s=request.getSession(true); String from=(String)s.getAttribute("from"); if(from==null){%><td><a href="assemble10.jsp">Skip This One</a></td><% } %><td><input type="image" src="success.png" value="success" name="s2"></td></tr>
              
          </table>
      </form>
      
  </div>
  <div id="preview"><% String type=(String)s.getAttribute("type"); AssembleBean ob=new AssembleBean();ResultSet rs=ob.getTypeResults(type,"Internalwriter"); while(rs.next()){%>
