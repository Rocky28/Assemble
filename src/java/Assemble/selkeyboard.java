...
@WebServlet(name = "selkeyboard", urlPatterns = {"/selkeyboard"})
public class selkeyboard extends HttpServlet {
/*    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException 
    {
        String processor=request.getParameter("choosekeyboard");
        ...
        {
            try{
                ResultSet rs=ob.getUserKeyboardChoice(processor);
                rs.next();
                ...
                response.sendRedirect("assemble12pre.jsp");
            }
            catch(Exception ex){
        ...
        else
        {
            ...
            if(processor==null)
            {
                ...
                ob.insertUpdateKeyboard(cmp, price, "sinha.aot@gmail.com");
            }
            else
            {
                int price=ob.getKeyboardPrice(processor);
                ob.insertUpdateKeyboard(processor, price, "sinha.aot@gmail.com");
            }
                ...
                if(processor==null)
            {
                ...
                ob.insertUpdateReviewKeyboard(cmp, price, "sinha.aot@gmail.com");
            }
            else
            {
                int price=ob.getKeyboardPrice(processor);
                ob.insertUpdateReviewKeyboard(processor, price, "sinha.aot@gmail.com");
            }
