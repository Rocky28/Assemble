...
@WebServlet(name = "selram", urlPatterns = {"/selram"})
public class selram extends HttpServlet {
/*    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException 
    {
        String processor=request.getParameter("chooseram");
        ...
        {
            try{
                ResultSet rs=ob.getUserRamChoice(processor);
                rs.next();
                ...
                response.sendRedirect("assemble5pre.jsp");
            }
            catch(Exception ex){
        ...
        else
        {
            if(processor==null)
            {
                ...
                ob.insertUpdateRam(cmp, price, "sinha.aot@gmail.com");
            }
            else
            {
