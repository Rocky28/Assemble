...
@WebServlet(name = "selpsu", urlPatterns = {"/selpsu"})
public class selpsu extends HttpServlet {
/*    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
   ...
   //     processRequest(request, response);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException 
    {
        String processor=request.getParameter("choosepsu");
        ...
        {
            try{
                ResultSet rs=ob.getUserPsuChoice(processor);
                rs.next();
                ...
                response.sendRedirect("assemble14pre.jsp");
            }
            catch(Exception ex){
        ...
        else
        {
            ...
            if(processor==null)
            {
                ...
                ob.insertUpdatePsu(cmp, price, "sinha.aot@gmail.com");
            }
            else
            {
