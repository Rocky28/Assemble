...
@WebServlet(name = "selmotherboard", urlPatterns = {"/selmotherboard"})
public class selmotherboard extends HttpServlet {
/*    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException 
    {
        String motherboard=request.getParameter("choosemotherboard");
        ...
        {
            try{
                ResultSet rs=ob.getUserMotherboardChoice(motherboard);
                rs.next();
                ...
                response.sendRedirect("assemble2pre.jsp");
            }catch(Exception ex) {
        ...
        else
        {
            ...
            if(motherboard==null)
            {
                ...
                ob.insertUpdateMotherboard(cmp, price, "sinha.aot@gmail.com");
            }
            else
            {
