...
@WebServlet(name = "selsoundcard", urlPatterns = {"/selsoundcard"})
public class selsoundcard extends HttpServlet {
/*    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException 
    {
        String processor=request.getParameter("choosesoundcard");
        ...
        {
            try{
                ResultSet rs=ob.getUserSoundcardChoice(processor);
                rs.next();
                ...
                response.sendRedirect("assemble15pre.jsp");
            }
            catch(Exception ex){
        ...
        else
        {
            if(processor==null)
            {
                ...
                ob.insertUpdateSoundcard(cmp, price, "sinha.aot@gmail.com");
            }
            else
            {
